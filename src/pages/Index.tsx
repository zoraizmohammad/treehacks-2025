    ...
    <div className="min-h-screen relative">
      ...
      <section className="relative pt-32 pb-24 px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <span className="inline-block px-4 py-1.5 mb-6 text-sm font-medium rounded-full bg-teal-500/20 text-teal-300 backdrop-blur-sm">
              <span className="text-shadow">Introducing CipherShield</span>
            </span>
            <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-teal-200 to-cyan-200 bg-clip-text text-transparent text-shadow">
              Making discrimination mathematically impossible
            </h1>
            <div className="glass-card inline-block p-6 mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-semibold mb-3 text-white text-shadow">
                  {feature.title}
                </h3>
