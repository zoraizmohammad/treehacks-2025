...
const SecurityInfo: React.FC = () => {
  return (
    <>
      <div className="bg-white p-6 rounded-lg shadow-md border border-[#0FA0CE]/20 flex flex-col items-center text-center order-2">
        <Lock className="w-8 h-8 text-[#0FA0CE] mb-4" />
        <h3 className="text-xl font-semibold mb-2 text-[#0FA0CE]">Homomorphically Encrypted Data</h3>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md border border-[#0FA0CE]/20 flex flex-col items-center text-center order-1">
