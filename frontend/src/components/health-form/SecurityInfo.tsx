...
const SecurityInfo: React.FC = () => {
  return (
    <>
      <div className="glass-card p-6 flex flex-col items-center text-center order-2">
        <Lock className="w-8 h-8 text-[#F97316] mb-4" />
        <h3 className="text-xl font-semibold mb-2 rainbow-text">Homomorphically Encrypted Data</h3>
      ...
      <div className="glass-card p-6 flex flex-col items-center text-center order-1">
